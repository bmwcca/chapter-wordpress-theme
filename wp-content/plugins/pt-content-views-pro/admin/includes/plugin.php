	...
	class PT_CV_Plugin_Pro {
		...
		public static function field_callback_license_key() {
			...
			if ( !get_option( 'pt_cv_pro_activate' ) ) {
				...
				$text = sprintf( '<a href="//www.contentviewspro.com/license-key-info/?license_key=%s" target="_blank" style="color:#ff5a5f;font-weight:600;text-decoration:underline">License Details</a>', PT_CV_Functions::get_option_value( 'license_key' ) );
			}
