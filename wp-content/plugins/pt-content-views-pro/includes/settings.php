				...
				'params'		 => array(
					array(
						...
						'params' => array(
							...
							self::field_settings_font(
								array(
									'label'			 => __( 'Hover animation, Mask box', 'content-views-pro' ),
									'name'			 => 'mask',
									'depend_multi'	 => array( array( 'anm-content-hover', 'yes' ), array( 'force-mask', 'yes' ) ),
									'skip_all'		 => 1,
									'bgcolor'		 => 'rgba(51,51,51,.6)',
								)
							),
					...
					$result = array(
						...
						'params'		 => array(
							array(
								'type'	 => 'group',
								'params' => array(
									self::_padding_margin_settings( 'item-margin-value-', __( 'Item margin', 'content-views-pro' ), array( 'bottom' ), __( 'To get items close together, you can set negative value', 'content-views-pro' ) ),
				...
				array(
					...
					'params' => array(
						array(
							...
							'options'	 => PT_CV_Values::yes_no( 'yes', __( 'Show fields on mouse over thumbnail, with animation:', 'content-views-pro' ) ),
							'std'		 => '',
						),
					),
				),
								...
								array(
									...
									'params'		 => array(
										array(
											...
											'options'	 => PT_CV_Values::yes_no( 'yes', __( 'Make it clickable on hover', 'content-views-pro' ) ),
											'std'		 => '',
										),
									),
									'dependence'	 => array( $prefix . 'content-hover', 'yes' ),
